...
class Model_invoice extends CI_Model
{
	public function index()
	{
		...
		// Pengecekan nilai 'ekspedisi'
        if (isset($invoice['ekspedisi']) && !is_null($invoice['ekspedisi'])) {
            $this->db->insert('transaction', $invoice);
            $id_invoice = $this->db->insert_id();
        } else {
            // Handle error ketika nilai 'ekspedisi' kosong atau null
            echo "Nilai 'ekspedisi' tidak boleh kosong";
            return false; // Menghentikan proses lebih lanjut jika terjadi kesalahan
        }
