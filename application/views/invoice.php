          ...
          <div class="border-b border-slate-200/60 dark:border-darkmode-400 text-center sm:text-left">
              ...
              <div class="flex flex-col lg:flex-row px-5 sm:px-20 pt-10 pb-10 sm:pb-20">
                  ...
                  <div class="lg:text-right mt-10 lg:mt-0 lg:ml-auto">
                      ...
                      <div class="text-lg font-medium text-primary mt-2">IEGCODE Commerce</div>
                      <div class="mt-1">iegcodeid@gmail.com</div>
                  </div>
              </div>
          </div>
          <div class="px-5 sm:px-16 py-10 sm:py-20">
              <div class="overflow-x-auto">
                  <table class="table table-striped">
                      ...
                      <tbody>
                          <?php
                            $total = 0; // Inisialisasi variabel total sebelum perulangan
                            if (isset($pesanan) && is_array($pesanan)) { // Periksa apakah $pesanan adalah array dan memiliki nilai yang valid
                                foreach ($pesanan as $row) { // Mulai perulangan
                                    $subtotal = $row->jumlah * $row->harga; // Hitung subtotal
                          ...
                          <?php
                                ...
                                echo "<tr><td colspan='4'>Data pesanan tidak tersedia</td></tr>"; // Menampilkan pesan jika $pesanan tidak valid
                            }
                            ?>
                      </tbody>
